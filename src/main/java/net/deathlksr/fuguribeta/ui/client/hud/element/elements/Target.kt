...
import net.deathlksr.fuguribeta.ui.client.hud.element.elements.targets.impl.*
...
class Targets : Element(-46.0, -40.0, 1F, Side(Side.Horizontal.MIDDLE, Side.Vertical.MIDDLE)) {
    ...
    var target = FuguriBeta.combatManager.target
    ...
    override fun drawElement(): Border? {
        ...
        val actualTarget = if (FuguriBeta.combatManager.target != null && (!onlyPlayer || FuguriBeta.combatManager.target is EntityPlayer)) FuguriBeta.combatManager.target
        else if (FuguriBeta.combatManager.target != null && (!onlyPlayer || FuguriBeta.combatManager.target is EntityPlayer)) FuguriBeta.combatManager.target
