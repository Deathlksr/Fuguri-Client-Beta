 ...
 */
package net.deathlksr.fuguribeta.features.module.modules.player.scaffolds
...
import net.deathlksr.fuguribeta.utils.block.BlockUtils.isReplaceable
import net.deathlksr.fuguribeta.utils.block.PlaceInfo
...
import net.deathlksr.fuguribeta.utils.timing.DelayTimer
import net.deathlksr.fuguribeta.utils.timing.MSTimer
import net.deathlksr.fuguribeta.utils.timing.TickDelayTimer
...
object Scaffold : Module("Scaffold", Category.PLAYER, Keyboard.KEY_I, hideModule = false) {
    ...
    // Rotation Options
    val rotationMode by ListValue("RotationHandler", arrayOf("Off", "Normal", "Stabilized", "GodBridge"), "Normal")
