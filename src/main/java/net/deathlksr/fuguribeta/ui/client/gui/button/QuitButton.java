...
import static net.deathlksr.fuguribeta.ui.font.Fonts.fontSmall;
import static net.deathlksr.fuguribeta.utils.render.RenderUtils.drawCustomShapeWithRadius;
import static net.deathlksr.fuguribeta.utils.render.RenderUtils.drawRoundOutline;

public class QuitButton extends ImageButton {

	public QuitButton(int x, int y) {
		super("QUIT", new ResourceLocation("fuguribeta/mainmenu/exit.png"), x, y);
	}
