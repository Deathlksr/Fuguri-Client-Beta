 ...
 */
package net.deathlksr.fuguribeta.file
...
import net.deathlksr.fuguribeta.file.configs.*
import net.deathlksr.fuguribeta.utils.Background.Companion.createBackground
...
object FileManager : MinecraftInstance() {
    ...
    val dir = File(mc.mcDataDir, "FuguriBeta")
    ...
    fun load(name: String, save: Boolean = true) {
        FuguriBeta.isLoadingConfig = true
        ...
        FuguriBeta.isLoadingConfig = false
    }
}