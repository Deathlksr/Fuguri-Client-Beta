package net.deathlksr.fuguribeta.utils.splash;
...
public class CustomSplashProgress {
    ...
    public static void start() {
        ...
        final ResourceLocation backgroundLoc = new ResourceLocation(getString("backgroundTexture", "fuguribeta/splash.png"));
    ...
    private static void disableSplash(final Exception e) {
        if (disableSplash()) {
