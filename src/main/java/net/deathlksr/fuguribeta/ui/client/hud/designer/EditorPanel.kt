 ...
 */
package net.deathlksr.fuguribeta.ui.client.hud.designer


import net.deathlksr.fuguribeta.features.module.modules.client.HUDModule.colorBlue
import net.deathlksr.fuguribeta.features.module.modules.client.HUDModule.colorGreen
import net.deathlksr.fuguribeta.features.module.modules.client.HUDModule.colorRed
import net.deathlksr.fuguribeta.features.module.modules.client.HUDModule.guiColor
import net.deathlksr.fuguribeta.ui.client.hud.HUD
import net.deathlksr.fuguribeta.ui.client.hud.HUD.ELEMENTS
...
import net.deathlksr.fuguribeta.utils.render.RenderUtils.drawGradientRoundedRect
import net.deathlksr.fuguribeta.utils.render.RenderUtils.drawRect
import net.deathlksr.fuguribeta.utils.render.RenderUtils.drawRoundedCornerRect
import net.deathlksr.fuguribeta.utils.render.RenderUtils.makeScissorBox
