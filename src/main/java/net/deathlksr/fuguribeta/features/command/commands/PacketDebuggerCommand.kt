...
import net.deathlksr.fuguribeta.features.module.modules.exploit.PacketDebugger.selectedPackets
import net.deathlksr.fuguribeta.features.module.modules.exploit.PacketDebugger.packetType
...
object PacketDebuggerCommand : Command("packetdebugger", "debug") {
    ...
    init {
        runCatching {
            javaClass.getResourceAsStream("/assets/minecraft/fuguribeta/packets.txt")!!.bufferedReader().use {
