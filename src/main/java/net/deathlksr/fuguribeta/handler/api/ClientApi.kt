...
import net.deathlksr.fuguribeta.utils.misc.HttpUtils.post

import net.deathlksr.fuguribeta.utils.misc.HttpUtils.request
...
object ClientApi {
     ...
     */
    private val ENDPOINT_AGENT = "${FuguriBeta.CLIENT_NAME}/${FuguriBeta.clientVersionText} (${FuguriBeta.clientCommit}, ${FuguriBeta.clientBranch}, ${if (FuguriBeta.IN_DEV) "dev" else "release"}, ${System.getProperty("os.name")})"
