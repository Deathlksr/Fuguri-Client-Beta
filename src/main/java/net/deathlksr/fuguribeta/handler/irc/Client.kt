 ...
 */
package net.deathlksr.fuguribeta.handler.irc
...
import net.deathlksr.fuguribeta.handler.irc.packet.PacketDeserializer
import net.deathlksr.fuguribeta.handler.irc.packet.PacketSerializer
import net.deathlksr.fuguribeta.handler.irc.packet.packets.*
import net.deathlksr.fuguribeta.utils.MinecraftInstance
import net.deathlksr.fuguribeta.utils.login.UserUtils
import java.net.URI
import java.util.*
...
abstract class Client : ClientListener, MinecraftInstance() {
    ...
    fun connect() {
        ...
        val uri = URI("wss://chat.fuguribeta.net:7886/ws")
