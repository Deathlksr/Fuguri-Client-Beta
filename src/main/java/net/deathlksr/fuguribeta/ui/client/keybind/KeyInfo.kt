 ...
 */
package net.deathlksr.fuguribeta.ui.client.keybind
...
import net.deathlksr.fuguribeta.ui.font.Fonts.font40
import net.deathlksr.fuguribeta.ui.font.Fonts.fontSmall
import net.deathlksr.fuguribeta.utils.MinecraftInstance
import net.deathlksr.fuguribeta.utils.render.RenderUtils.drawRoundedBindRect
...
class KeyInfo(
    ...
    fun click(mouseX: Float, mouseY: Float) {
        val keyBindMgr = FuguriBeta.keyBindManager
